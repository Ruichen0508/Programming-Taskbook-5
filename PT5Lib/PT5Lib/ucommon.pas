...
type
  TData = record
    id: char;            // b, i, r, c, s      //V2 - I, R, C, S, T (files)
...
const
   ...
   libstl  = '|STL1ITER|STL2SEQ|STL3ALG|STL4STR|STL5ASSOC|STL6FUNC|';
...
begin
  case n of
  lgPascal       : result := 'Pascal';     //[=Pascal]
//  lgVB           : result := 'VB';         //[=VB]
  lgCPP          : result := 'CPP';        //[=CPP]
//  lgCS           : result := 'CS';         //[=CS]
//  lgVBNET        : result := 'VB.NET';     //[=VB.NET]
  lg1C           : result := '1C';         //[=1C]
//2015.11a>
//2015.05>
//  lgPython       : result := 'Python-2';   //[=Python-2]
//  lgPython3      : result := 'Python-3';   //[=Python-3]
//2015.05<
//2015.11a<
//  lgJava         : result := 'Java';       //[=Java]
//  lgRuby         : result := 'Ruby';       //[=Ruby]
//  lgPascalABCNET : result := 'PascalABC';  //[=PascalABC]
//  lgFS           : result := 'FS';         //[=FS] //2020.09
//  lgJulia        : result := 'Julia';      //[=Julia] //2022.02
  lgC            : result := 'C';          //[=Julia] //2022.08
  else             result := '';
  end;
end;
}
...
begin
  ...
  begin
    ...
    begin
//        FreeAttr(Path + ExtractFilePath(Mask) + DirInfo.Name);
