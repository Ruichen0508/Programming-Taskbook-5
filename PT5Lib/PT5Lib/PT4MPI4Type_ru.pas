...
const
  prcname = 'Процесс %d: ';
  topic1 = 'Использование простейших производных типов';
  topic2 = 'Пересылка упакованных данных';
  topic3 = 'Более сложные виды производных типов';
  topic4 = 'Коллективная функция MPI_Alltoallw (MPI-2)';
...
begin
  ...
  CreateGroup('MPI4Type', 'Производные типы и упаковка данных', 'М. Э. Абрамян, 2010,2017',
